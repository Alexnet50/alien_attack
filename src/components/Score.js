...
function Score(props) {
    ...
    return (
        <>
            <div className='title' style={{ marginTop: 10, textAlign: 'center', fontSize: 24 * coeff, fontWeight: 'bold' }}>ALIEN ATTACK</div>
            <div style={{ margin: '5px auto', width: '900px', display: 'flex', justifyContent: 'space-between' }}>
